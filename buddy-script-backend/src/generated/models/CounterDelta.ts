...
// @ts-nocheck 
/*
 * This file exports the `CounterDelta` model and its related types.
 *
...
export type GetCounterDeltaAggregateType<T extends CounterDeltaAggregateArgs> = {
      [P in keyof T & keyof AggregateCounterDelta]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateCounterDelta[P]>
    : Prisma.GetScalarType<T[P], AggregateCounterDelta[P]>
}
...
export type GetCounterDeltaGroupByPayload<T extends CounterDeltaGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<CounterDeltaGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof CounterDeltaGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], CounterDeltaGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], CounterDeltaGroupByOutputType[P]>
      }
    >
  >
...
export type CounterDeltaCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<CounterDeltaFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface CounterDeltaDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['CounterDelta'], meta: { name: 'CounterDelta' } }
  /**
   ...
   * })
  **/
  count<T extends CounterDeltaCountArgs>(
    args?: Prisma.Subset<T, CounterDeltaCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], CounterDeltaCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends CounterDeltaGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, CounterDeltaGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetCounterDeltaGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
