 ...
 */
router.post('/', requireAuth, uploadPostImage.single('image'), validate(CreatePostSchema), postController.createPost);
/**
 * @swagger
 * /api/posts/{postId}:
 *   get:
 ...
 *                   $ref: '#/components/schemas/CursorPaginationMeta'
 */
router.get('/:postId/likes', requireAuth, validate(PaginationQuerySchema, 'query'), postController.getPostLikers);
