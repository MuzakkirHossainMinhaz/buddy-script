                        ...
                        <div className="_feed_inner_timeline_post_top">
                          ...
                          <div className="_feed_inner_timeline_post_box_dropdown">
                            <div className="_feed_timeline_post_dropdown">
                              <a href="#0" id="_timeline_show_drop_btn" className="_feed_timeline_post_dropdown_link" onClick={() => setTimelineDrop(!timelineDrop)}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="4" height="17" fill="none" viewBox="0 0 4 17">
                            ...
                            {/*Dropdown*/}
                            <div id="_timeline_drop" className={`_feed_timeline_dropdown _timeline_dropdown ${timelineDrop ? "show" : ""}`}>
