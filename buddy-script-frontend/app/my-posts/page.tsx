...
import { OriginalPostCard } from "@/components/feed/OriginalPostCard";
import {
...
export default function MyPostsPage() {
  ...
  const [loadMorePosts, { isFetching: isLoadingMorePosts }] = useLazyGetMyPostsQuery();
  ...
  const handleImageChange = (event: ChangeEvent<HTMLInputElement>) => {
    if (postImagePreviewUrlRef.current) {
      URL.revokeObjectURL(postImagePreviewUrlRef.current);
      postImagePreviewUrlRef.current = null;
    }

    const image = event.target.files?.[0] ?? null;
    const previewUrl = image ? URL.createObjectURL(image) : null;

    postImagePreviewUrlRef.current = previewUrl;
    setPostImage(image);
          ...
          <div className="container _custom_container">
            ...
            <div className="collapse navbar-collapse" id="navbarSupportedContent">
              ...
              <ul className="navbar-nav mb-2 mb-lg-0 _header_nav_list ms-auto _mar_r8">
                ...
                <li className="nav-item _header_nav_item">
                  <span id="_notify_btn" className="nav-link _header_nav_link _header_notify_btn" onClick={() => setNotifyDrop(!notifyDrop)}>
                    ...
                    <div id="_notify_drop" className={`_notification_dropdown ${notifyDrop ? "show" : ""}`}>
              ...
              <div className="_header_nav_profile">
                ...
                <div className="_header_nav_dropdown">
                  ...
                  <button id="_profile_drop_show_btn" className="_header_nav_dropdown_btn _dropdown_toggle" onClick={() => setProfileDrop(!profileDrop)} type="button">
                ...
                {/* dropdown */}
                <div id="_prfoile_drop" className={`_nav_profile_dropdown _profile_dropdown ${profileDrop ? "show" : ""}`} >
                  <ul className="_nav_dropdown_list">
                    <li className="_nav_dropdown_list_item">
                      <a href="/my-posts" className="_nav_dropdown_link">
                ...
                <div className="_layout_middle_wrap">
                  <div className="_layout_middle_inner">
                    ...
                    <div className="_feed_inner_text_area  _b_radious6 _padd_b24 _padd_t24 _padd_r24 _padd_l24 _mar_b16">
                      <div className="_feed_inner_text_area_box">
                        ...
                        <div className="form-floating _feed_inner_text_area_box_form ">
                          ...
                          <label
                            ...
                            style={postText.trim() ? { opacity: 0, pointerEvents: "none" } : undefined}
                          >Write something ...
                      ...
                      {postImagePreviewUrl ? (
                        <div className="_bs_post_image_preview">
                          <img src={postImagePreviewUrl} alt="Selected post image preview" className="_bs_post_image_preview_img" />
                          <div className="_bs_post_image_preview_meta">
                            <span>{postImage?.name}</span>
                            <button type="button" onClick={handleRemoveImage} className="_bs_post_image_preview_remove">
                              Remove
                            </button>
                          </div>
                        </div>
                      ...
                      <div className="_feed_inner_text_area_bottom">
                        <div className="_feed_inner_text_area_item">
                          <div className="_feed_inner_text_area_bottom_photo _feed_common">
                            <button type="button" className="_feed_inner_text_area_bottom_photo_link" onClick={() => postImageInputRef.current?.click()}> <span className="_feed_inner_text_area_bottom_photo_iamge _mar_img"> <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none" viewBox="0 0 20 20">
                              ...
                              Photo</button>
                            <input id="post-image-input" ref={postImageInputRef} type="file" accept="image/*" hidden onChange={handleImageChange} />
                          </div>
                        ...
                        <div className="_feed_inner_text_area_btn">
                          <button type="button" className="_feed_inner_text_area_btn_link" onClick={() => handleCreatePost()} disabled={isCreatingPost}>
                            ...
                            </svg> <span>{isCreatingPost ? "Posting..." : "Post"}</span>
                          </button>
                        </div>
                      </div>
                      {/*For Desktop*/}
                    ...
                    {isPostsLoading ? (
                      <div className="_feed_inner_timeline_post_area _b_radious6 _padd_b24 _padd_t24 _mar_b16" style={{ minHeight: "120px", display: "flex", alignItems: "center", justifyContent: "center" }}>
